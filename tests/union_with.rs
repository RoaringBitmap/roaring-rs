...
fn bitmap_and_array() {
    let mut bitmap1: RoaringBitmap = (0..12000).collect();
    let bitmap2: RoaringBitmap = (10000..13000).collect();
    let bitmap3: RoaringBitmap = (0..13000).collect();
...
fn arrays() {
    ...
    let bitmap3: RoaringBitmap = (0..3000).chain(1000000..1003000).chain(2000000..2001000).chain(3000000..3001000).collect();
...
fn bitmaps() {
    ...
    let bitmap3: RoaringBitmap = (0..9000).chain(1000000..1018000).chain(2000000..2010000).chain(3000000..3010000).collect();
