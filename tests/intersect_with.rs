...
fn array() {
    ...
    let bitmap3: RoaringBitmap<u32> = (1000..2000u32).collect();
...
#[test]
fn no_intersection() {
    let mut bitmap1: RoaringBitmap<u32> = (0..2).collect();
    let bitmap2: RoaringBitmap<u32> = (3..4).collect();
...
fn bitmap_to_bitmap() {
    ...
    let bitmap3: RoaringBitmap<u32> = (6000..12000u32).collect();
...
fn bitmap_to_array() {
    ...
    let bitmap3: RoaringBitmap<u32> = (3000..6000u32).collect();
...
fn bitmap_and_array() {
    let mut bitmap1: RoaringBitmap<u32> = (0..12000u32).collect();
    let bitmap2: RoaringBitmap<u32> = (7000..9000u32).collect();
    let bitmap3: RoaringBitmap<u32> = (7000..9000u32).collect();
...
fn arrays() {
    ...
    let bitmap3: RoaringBitmap<u32> = (1000..2000u32).chain(1001000..1002000u32).collect();
...
fn bitmaps() {
    ...
    let bitmap3: RoaringBitmap<u32> = (3000..6000u32).chain(1006000..1012000u32).collect();
