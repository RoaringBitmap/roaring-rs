...
fn arrays() {
    ...
    let bitmap3 = RoaringTreemap::from_iter((0..3000).chain(1000000..1003000).chain(2000000..2001000).chain(3000000..3001000));
...
fn bitmaps() {
    ...
    let bitmap3 = RoaringTreemap::from_iter((0..9000).chain(1000000..1018000).chain(2000000..2010000).chain(3000000..3010000));
