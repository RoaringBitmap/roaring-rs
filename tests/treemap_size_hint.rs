...
#[test]
fn arrays() {
    let bitmap = RoaringTreemap::from_iter((0..2000).chain(1000000..1002000).chain(2000000..2001000));
    let mut iter = bitmap.iter();
...
#[test]
fn bitmaps() {
    let bitmap = RoaringTreemap::from_iter((0..6000).chain(1000000..1012000).chain(2000000..2010000));
    let mut iter = bitmap.iter();
