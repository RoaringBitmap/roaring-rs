...
#[test]
fn arrays() {
    let bitmap1 = RoaringBitmap::from_iter((0..2000).chain(1000000..1002000).chain(2000000..2002000));
    let bitmap2 = RoaringBitmap::from_iter((100000..102000).chain(1100000..1102000));
    assert_eq!(bitmap1.is_disjoint(&bitmap2), true);
}
...
#[test]
fn bitmaps() {
    let bitmap1 = RoaringBitmap::from_iter((0..6000).chain(1000000..1006000).chain(2000000..2006000));
    let bitmap2 = RoaringBitmap::from_iter((100000..106000).chain(1100000..1106000));
    assert_eq!(bitmap1.is_disjoint(&bitmap2), true);
}
