...
fn arrays() {
    ...
    let bitmap2 = RoaringBitmap::from_iter((1000..3000).chain(1001000..1003000).chain(2000000..2000001));
    let bitmap3 = RoaringBitmap::from_iter((0..1000).chain(1000000..1001000).chain(2000..3000).chain(1002000..1003000).chain(2000000..2000001).chain(3000000..3001000));
...
fn bitmaps() {
    ...
    let bitmap2 = RoaringBitmap::from_iter((3000..7000).chain(1006000..1018000).chain(2000000..2010000));
    let bitmap3 = RoaringBitmap::from_iter((0..3000).chain(1000000..1006000).chain(6000..7000).chain(1012000..1018000).chain(2000000..2010000).chain(3000000..3010000));
