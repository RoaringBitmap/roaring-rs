...
fn array() {
    ...
    let bitmap3 = (0..1000).collect::<Roaring32>();
...
#[test]
fn no_difference() {
    let mut bitmap1 = (1..3).collect::<Roaring32>();
    let bitmap2 = (1..3).collect::<Roaring32>();
...
fn bitmap_to_bitmap() {
    ...
    let bitmap3 = (0..6000).collect::<Roaring32>();
...
fn bitmap_to_array() {
    ...
    let bitmap2 = (3000..9000).collect::<Roaring32>();
...
fn bitmap_and_array_to_bitmap() {
    let mut bitmap1 = (0..12000).collect::<Roaring32>();
    let bitmap2 = (9000..12000).collect::<Roaring32>();
    let bitmap3 = (0..9000).collect::<Roaring32>();
...
fn bitmap_and_array_to_array() {
    let mut bitmap1 = (0..6000).collect::<Roaring32>();
    let bitmap2 = (3000..6000).collect::<Roaring32>();
    let bitmap3 = (0..3000).collect::<Roaring32>();
...
fn arrays() {
    ...
    let bitmap3 = (0..1000).chain(1_000_000..1_001_000).collect::<Roaring32>();
...
fn arrays_removing_one_whole_container() {
    let mut bitmap1 =
        (0..2000).chain(1_000_000..1_002_000).chain(2_000_000..2_001_000).collect::<Roaring32>();
    let bitmap2 =
        (0..3000).chain(1_001_000..1_003_000).chain(2_000_000..2_001_000).collect::<Roaring32>();
    let bitmap3 = (1_000_000..1_001_000).collect::<Roaring32>();
...
fn bitmaps() {
    ...
    let bitmap3 = (0..3000).chain(1_000_000..1_006_000).collect::<Roaring32>();
