...
impl RoaringBitmap {
    ...
    /// [RoaringBitmap::deserialize_from_unchecked]
    ///
    /// [format]: https://github.com/RoaringBitmap/RoaringFormatSpec
    ///
    /// # Examples
    ...
    /// let mut bytes = vec![];
    /// rb1.serialize_into(&mut bytes).unwrap();
    /// let rb2 = RoaringBitmap::deserialize_from_unchecked(&bytes[..]).unwrap();
    ///
    /// assert_eq!(rb1, rb2);
    /// ```
    pub fn deserialize_from_unchecked<R: io::Read>(reader: R) -> io::Result<RoaringBitmap> {
